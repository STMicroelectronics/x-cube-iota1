...
/* Private functions -------------------------------------------------------- */
void test_deser_mileston_message(void)
{
...
void test_deser_tx_message(void)
{
  char const* const json_mileston =
...
void test_get_msg_meta(void)
{
  // Indexation payload
  char const* const id_str = "00091b53c1591f745b7ea7c56074ece2dd1177032369f9463da8fa7cfc918acf";
  // Mileston payload
