...
{
  byte_t tmp_addr[IOTA_ADDRESS_BYTES] = {0};
  byte_t bin_pub[ED_PUBLIC_KEY_BYTES] = {0};
  // hex to binary
...
int get_data_message(void)
{
  ...
  char const *const msg_id = "4c42ee4d6c066970d69c54e601ada15bc1492e10b57c4947eec4eea9de652e7f";
